...
View Tasks: Displays all saved tasks together with their priority, completion status, and deadlines.

Add Task: Users can create new study tasks by entering a title, description, deadline, and priority level.

Search Task: Allows users to search tasks using keyword matching based on task titles.

Mark Completed: Updates a selected task’s status from “Pending” to “Completed.”

Delete Task: Removes unnecessary or completed tasks from the system.

Save and Load Tasks: Uses file handling to permanently store tasks in a text file and automatically reload them when the program starts.

Task Statistics: Displays total tasks, completed tasks, pending tasks, and overall completion percentage.
...
Mathematics Assignment | High | Pending | Deadline: 2026-05-20
Physics Reviewer | Medium | Completed | Deadline: 2026-05-25
...
🎮 Controls
[1] Add Task — create new study tasks
[2] View Tasks — display all existing tasks
[3] Search Task — search tasks using keywords
[4] Mark Completed — update task status
[5] Delete Task — remove selected task
[6] Show Statistics — display task statistics
[7] Save Tasks — save tasks into file
...
🧪 Algorithms Used
Bubble Sort
Used to automatically organize tasks according to task priority.

Linear Search
Used to search task titles through keyword matching.
